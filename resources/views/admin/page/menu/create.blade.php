...
<div class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-6">
    ...
    <div class="max-w-4xl mx-auto mb-8">
        <div class="flex items-center gap-4 mb-2">
            ...
            <div>
                <h1 class="text-3xl font-bold text-white">Tambah Menu Baru</h1>
                <p class="text-slate-400 text-sm mt-1">Isi form di bawah untuk menambahkan menu</p>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('admin.menu.store') }}"
        ...
        <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl shadow-2xl overflow-hidden">
            <div class="p-8 space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <select name="nama" id="nama-menu-select"
                        ...
                        @foreach($namamenus as $nm)
                            <option value="{{ $nm }}" {{ old('nama') == $nm ? 'selected' : '' }}>
                                {{ $nm }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="deskripsi"
                              ...
                              rows="4"
                              placeholder="Tulis deskripsi menu di sini...">{{ old('deskripsi') }}</textarea>
                </div>
                    ...
                    <div class="flex items-center gap-4">
                            ...
                            <div class="relative border-2 border-dashed border-slate-600 rounded-lg p-6 hover:border-gacoan-500 transition-all group">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="mt-2 text-sm text-slate-400">
                                        <span class="text-gacoan-500 font-semibold">Upload gambar</span> atau drag & drop
                                    </p>
                        ...
                        <div id="preview-container" class="hidden">
                            <div class="relative group">
                                <img id="preview-gambar" class="w-32 h-32 object-cover rounded-lg ring-2 ring-slate-600">
            ...
            <div class="bg-slate-900/80 px-8 py-6 border-t border-slate-700 flex flex-wrap gap-4">
                <button type="submit"
                        class="group inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-gacoan-600 to-gacoan-500 text-white rounded-xl shadow-lg hover:shadow-gacoan-500/50 transition-all duration-300 hover:scale-105 font-semibold">
